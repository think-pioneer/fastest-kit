package xyz.thinktest.fastest.common.json.jsonpath;
...
class SelectorCompiler {
    private static final FastLogger logger = FastLoggerFactory.getLogger(FilterCompiler.class);
    ...
    public static Selector compile(String filterString) {
        SelectorCompiler compiler = new SelectorCompiler(filterString);
        return new CompiledSelector(compiler.compile());
    }

    private SelectorCompiler(String filterString) {
    ...
    private static final class CompiledSelector extends Selector {

        private final Predicate predicate;

        private CompiledSelector(Predicate predicate) {
